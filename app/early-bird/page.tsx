...
export default function EarlyBirdPage() {
  return (
    <main className="min-h-screen overflow-hidden bg-[#040816] text-white">
      <section className="relative px-5 pb-20 pt-8 sm:pt-10 lg:pb-28">
        ...
        <div className="relative mx-auto max-w-7xl">
          <Link
            href="/"
            className="inline-flex items-center gap-2 rounded-2xl border border-white/10 bg-white/[0.045] px-4 py-3 text-sm font-black text-white/70 backdrop-blur-xl transition hover:bg-white/10 hover:text-white"
          >
            <ArrowLeft size={17} />
            Back to RemoteForge
          </Link>
          ...
          <div className="mx-auto mt-16 max-w-4xl text-center">
            ...
            <h1 className="mt-6 text-5xl font-black leading-[0.95] tracking-[-0.06em] md:text-7xl">
          ...
          <div className="mx-auto mt-14 max-w-4xl overflow-hidden rounded-[2rem] border border-cyan-300/15 bg-white/[0.045] p-6 text-center shadow-2xl shadow-black/30 backdrop-blur-xl md:p-8">
            ...
            <p className="mx-auto mt-4 max-w-2xl leading-8 text-white/60">
              ...
              Open the Android app, sign in, go to Premium or Account, and
              redeem the code to unlock your plan.
            </p>

            <div className="mt-6 grid gap-3 text-left md:grid-cols-3">
              <Step number="1" text="Buy early-bird plan on this page." />
