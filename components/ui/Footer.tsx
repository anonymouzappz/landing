          ...
          <div className="relative overflow-hidden rounded-[2rem] border border-cyan-300/10 bg-white/[0.03] p-8 backdrop-blur-2xl">
            ...
            <div className="relative">
              ...
              <h3 className="mt-4 text-3xl font-black leading-tight text-white">
                Start building your RemoteForge setup today.
              </h3>

              <p className="mt-4 text-sm leading-7 text-white/58">
                Download the Windows Companion and prepare for the Android app
                launch.
              </p>
              ...
              <a
                ...
                className="mt-7 inline-flex items-center gap-2 rounded-2xl bg-gradient-to-r from-cyan-300 via-blue-400 to-violet-500 px-6 py-4 font-black text-black shadow-[0_0_35px_rgba(34,211,238,.35)] transition hover:-translate-y-0.5"
              >
                <Download size={18} />
                Download Companion
              </a>
